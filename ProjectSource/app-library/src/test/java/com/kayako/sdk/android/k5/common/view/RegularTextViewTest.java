...
public class RegularTextViewTest {
    ...
    public void givenContextWhenConstructClassThenApplyFont() {
        ...
        FontUtils.applyFont(context, regularTextView, FontUtils.FontStyle.REGULAR);
    }
    ...
    public void givenContextAttributesSetDefAttrWhenConstructClassThenApplyFont() {
        ...
        RegularTextView regularTextView =
                new RegularTextView(context, attributeSet, DEF_STYLE_ATTR);
    ...
    public void givenContextAttributesSetDefAttrDefResWhenConstructClassThenApplyFont() {
        ...
        //Act
        RegularTextView regularTextView =
                new RegularTextView(context, attributeSet, DEF_STYLE_ATTR, DEF_STYLE_RES);
