...
public class LightTextViewTest {
    ...
    public void givenContextWhenConstructClassThenApplyFont() {
        ...
        //Act
        LightTextView lightTextView = new LightTextView(context);

        //Assert
        verifyStatic(FontUtils.class);
        FontUtils.applyFont(context, lightTextView, FontUtils.FontStyle.LIGHT);
    }
    ...
    public void givenContextAttributesSetDefAttrWhenConstructClassThenApplyFont() {
        ...
        LightTextView lightTextView =
                new LightTextView(context, attributeSet, DEF_STYLE_ATTR);
    ...
    public void givenContextAttributesSetDefAttrDefResWhenConstructClassThenApplyFont() {
        ...
        //Act
        LightTextView lightTextView =
                new LightTextView(context, attributeSet, DEF_STYLE_ATTR, DEF_STYLE_RES);
