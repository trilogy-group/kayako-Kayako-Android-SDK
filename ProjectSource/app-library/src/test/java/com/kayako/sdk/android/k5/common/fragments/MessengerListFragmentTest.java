...
public class MessengerListFragmentTest {
    ...
    public void givenSavedInstanceWhenOnCreateThenCallOnCreate() {
        //Arrange
        MessengerListFragment messengerListFragmentPartialMock =
                spy(new MessengerListFragment());
        doNothing().when((BaseListFragment) messengerListFragmentPartialMock)
                .onCreate(bundle);
    ...
    @Test
    public void givenBaseListItemListWhenInitMessengerListThenCallInitMessengerList()
            throws Exception {
        //Arrange
        MessengerListFragment messengerListFragmentPartialMock =
                spy(new MessengerListFragment());
        doNothing().when((BaseListFragment) messengerListFragmentPartialMock)
                .scrollToBeginningOfList();
        List<BaseListItem> testList = new ArrayList<>();
        testList.add(baseListItem);
        whenNew(LinearLayoutManager.class).withAnyArguments()
                .thenReturn(linearLayoutManager);
        messengerListFragmentPartialMock.mRoot = view;
        when(view.getContext()).thenReturn(context);
        whenNew(MessengerAdapter.class).withAnyArguments()
                .thenReturn(messengerAdapter);
    ...
    public void givenOnAvatarClickListenerWhenSetOnAvatarClickListenerThenCallSetListener() {
        ...
        //Act
        messengerListFragmentPartialMock
    ...
    public void givenOnListAttachmentClickListenerWhenSetOnClickListenerThenCallSetListener() {
        ...
        //Act
        messengerListFragmentPartialMock
                .setOnListAttachmentClickListener(onAttachmentClickListener);
    ...
    public void givenPositionWhenScrollToPositionThenCallScroll() {
        ...
        //Assert
        verify(messengerListFragmentPartialMock)
    ...
    public void givenManagerWhenFindFirstVisibleItemPositionThenReturnInteger() {
        ...
        when(linearLayoutManager.findLastVisibleItemPosition())
                .thenReturn(INITIAL_POSITION);

        //Act
        int returnedValue = messengerListFragmentPartialMock
    ...
    public void givenManagerWhenShowEmptyViewAndHideOtherThenShowEmptyViewAndHideOthers() {
        ...
        when(powerView.findViewById(R.id.ko__stub_empty_state))
                .thenReturn(viewStub);
        when(powerView.findViewById(R.id.ko__stub_loading_state))
                .thenReturn(viewStub);
        when(powerView.findViewById(R.id.ko__stub_error_state))
                .thenReturn(viewStub);
        when(powerView.findViewById(R.id.ko__inflated_stub_empty_state))
                .thenReturn(powerView);
        when(powerView.findViewById(R.id.ko__empty_state_description))
                .thenReturn(textView);
        when(powerView.findViewById(R.id.ko__empty_state_title))
                .thenReturn(textView);
        suppress(method(DefaultStateViewHelper.class,
                "showEmptyView", eq(Context.class)));
        when(powerView.findViewById(R.id.ko__custom_state_container))
                .thenReturn(linearLayout);
    ...
    public void givenManagerWhenShowErrorViewAndHideOthersThenShowErrorViewAndHideOthers() {
        ...
        when(powerView.findViewById(R.id.ko__empty_state_title))
                .thenReturn(textView);
        suppress(method(DefaultStateViewHelper.class,
                "showErrorView", eq(Context.class)));
        when(powerView.findViewById(R.id.ko__custom_state_container))
                .thenReturn(linearLayout);
        suppress(method(CustomStateViewHelper.class, "hideAll"));
        messengerListFragmentPartialMock.setupView(powerView);
    ...
    @Test
    public void givenFragmentWhenGetCustomStateViewHelperThenGetCustomStateViewHelper()
            throws Exception {
        //Arrange
        whenNew(CustomStateViewHelper.class).withAnyArguments()
                .thenReturn(customStateViewHelper);
        final View powerView = PowerMockito.mock(View.class);
        when(powerView.findViewById(R.id.ko__list)).thenReturn(recyclerView);
        when(powerView.findViewById(R.id.ko__stub_empty_state))
                .thenReturn(viewStub);
        ...
        //Act
        CustomStateViewHelper returnedValue = messengerListFragment
                .getCustomStateViewHelper();
    ...
    @Test
    public void givenFragmentWhenGetDefaultStateViewHelperThenGetDefaultStateViewHelper()
            throws Exception {
        //Arrange
        ...
        //Act
        DefaultStateViewHelper returnedValue = messengerListFragment
                .getDefaultStateViewHelper();
    ...
    public void givenBaseListItemWhenAddItemThenAddItem() {
        ...
        //Assert
        verify(messengerListFragmentPartialMock)
                .addItem(baseListItem, INITIAL_POSITION);
    }
    ...
    public void givenBaseListItemWhenReplaceItemThenReplaceItem() {
        ...
        //Assert
        verify(messengerListFragmentPartialMock)
                .replaceItem(baseListItem, INITIAL_POSITION);
    }
    ...
    @Test
    public void givenScrollListenerWhenShowLoadMoreProgressThenShowLoadMoreProgress() {
        //Arrange
        MessengerListFragment messengerListFragmentPartialMock =
                spy(new MessengerListFragment());
        messengerListFragmentPartialMock.mRecyclerView = recyclerView;
        ...
        //Act
        messengerListFragmentPartialMock.showLoadMoreProgress();

        //Assert
        verify(messengerListFragmentPartialMock).showLoadMoreProgress();
    }

    @Test
    public void givenScrollListenerWhenHideLoadMoreProgressThenHideLoadMoreProgress() {
        //Arrange
        MessengerListFragment messengerListFragmentPartialMock =
                spy(new MessengerListFragment());
        messengerListFragmentPartialMock.mRecyclerView = recyclerView;
        ...
        //Act
        messengerListFragmentPartialMock.hideLoadMoreProgress();

        //Assert
        verify(messengerListFragmentPartialMock).hideLoadMoreProgress();
    }

    @Test
    public void givenBooleanWhenSetHasMoreItemsThenSetHasMoreItems() {
        //Arrange
        MessengerListFragment messengerListFragmentPartialMock =
                spy(new MessengerListFragment());
        messengerListFragmentPartialMock.mRecyclerView = recyclerView;
        ...
        //Act
        messengerListFragmentPartialMock.setHasMoreItems(Boolean.TRUE);

        //Assert
        verify(messengerListFragmentPartialMock).setHasMoreItems(Boolean.TRUE);
    }

    @Test
    public void givenBooleanWhenHasMoreItemsThenHasMoreItems() {
        //Arrange
        MessengerListFragment messengerListFragmentPartialMock =
                spy(new MessengerListFragment());
        messengerListFragmentPartialMock.mRecyclerView = recyclerView;
        messengerListFragmentPartialMock.init(messengerAdapter, linearLayoutManager);
        messengerListFragmentPartialMock.setLoadMoreListener(onLoadMoreListener);
        when(messengerAdapter.hasMoreItems()).thenReturn(Boolean.TRUE);

        //Act
        boolean returnedValue = messengerListFragmentPartialMock.hasMoreItems();
    ...
    @Test
    public void givenIdWhenFindPositionOfIdThenReturnIntegerList() {
        //Arrange
        MessengerListFragment messengerListFragmentPartialMock =
                spy(new MessengerListFragment());
        List<BaseListItem> testList = new ArrayList<>();
        ...
        //Act
        List<Integer> returnedValue = messengerListFragmentPartialMock
                .findPositionsOfId(ID);
    ...
    @Test
    public void givenManagerWhenIsNearEndOfListThenReturnBoolean() {
        //Arrange
        MessengerListFragment messengerListFragmentPartialMock =
                spy(new MessengerListFragment());
        messengerListFragmentPartialMock.mRecyclerView = recyclerView;
        ...
        //Act
        boolean returnedValue = messengerListFragmentPartialMock
                .isNearEndOfList();
    ...
    @Test
    public void givenManagerWhenScrollToNewMessagesIfNearbyThenScrollToNewMessagesIfNearby() throws Exception {
        //Arrange
        MessengerListFragment messengerListFragmentPartialMock =
                spy(new MessengerListFragment());
        doNothing().when((BaseListFragment) messengerListFragmentPartialMock)
        ...
        //Act
        messengerListFragmentPartialMock.scrollToNewMessagesIfNearby();
