...
public class InputFieldCommonStateHelper {
    ...
    public static void setErrorFieldState(Context context, ViewGroup inputFieldBackgroundLayout, TextView hintTextView) {
        inputFieldBackgroundLayout.setBackgroundResource(INPUT_FIELD_BACKGROUND_COLOR_ERROR);
        hintTextView.setTextColor(context.getResources().getColor(HINT_TEXT_COLOR_ERROR));
    }

    public static void setFocusedFieldState(Context context, ViewGroup inputFieldBackgroundLayout, TextView hintTextView) {
        inputFieldBackgroundLayout.setBackgroundResource(INPUT_FIELD_BACKGROUND_COLOR_DEFAULT);
        hintTextView.setTextColor(context.getResources().getColor(HINT_TEXT_COLOR_DEFAULT));
    }

    public static void setUnfocusedFieldState(Context context, ViewGroup inputFieldBackgroundLayout, TextView hintTextView) {
        inputFieldBackgroundLayout.setBackgroundResource(INPUT_FIELD_BACKGROUND_COLOR_FILLED);
