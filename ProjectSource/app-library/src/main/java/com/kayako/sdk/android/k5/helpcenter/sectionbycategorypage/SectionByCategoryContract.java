...
public interface SectionByCategoryContract {
    ...
    interface Data extends BaseData {
        List<Category> getCategories(boolean useCacheIfAvailable) throws KayakoException;

        Map<Category, List<Section>> getSectionsByCategory(List<Category> categories, boolean useCacheIfAvailable) throws KayakoException;
